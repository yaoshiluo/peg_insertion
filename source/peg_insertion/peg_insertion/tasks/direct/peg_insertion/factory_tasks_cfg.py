...
class FactoryTask:
    ...
    # Robot
    hand_init_pos: list = [0.0, 0.0, 0.02]  # Relative to fixed asset tip.
    #yaoshi
    # hand_init_pos: list = [0.4, 0.0, 0.015]
    hand_init_pos_noise: list = [0.01, 0.01, 0.01]
    hand_init_orn: list = [3.1416, 0, 0]
    hand_init_orn_noise: list = [0.0, 0.0, 0.785]
    # hand_init_pos_noise: list = [0.0, 0.0, 0.0]
    # hand_init_orn: list = [2.618, 0.0, 2.356]
...
class PegInsert(FactoryTask):
    ...
    # y axis
    #yaoshi
    fixed_asset_init_orn_pitch_deg: float = 0
    fixed_asset_init_orn_pitch_range_deg: float = 2.0
    ...
    held_asset: ArticulationCfg = ArticulationCfg(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            pos=(0.0, 0.4, 0.1), rot=(1.0, 0.0, 0.0, 0.0), 
            # automate don't need this
            joint_pos={}, joint_vel={}
        ),
        # automate don't need this
        actuators={},
...
class GearMesh(FactoryTask):
    ...
    # Robot
    hand_init_pos: list = [0.0, 0.0, 0.025]  # Relative to fixed asset tip.
    hand_init_pos_noise: list = [0.005, 0.005, 0.01]
